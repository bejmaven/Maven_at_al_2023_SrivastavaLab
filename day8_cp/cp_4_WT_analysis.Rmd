...
# 0. Overview
This script is to analyze just the WT cells in day 8 CPs. These data are for Supp Fig 1.
...
baseName = "cp_cardiac_WT"

dir.create(paste("../analyses/", baseName, sep = ""))

# Load the seurat_dataset object.
cp_cardiac_WT <- readRDS(file = paste("../data/RDS/", baseName, ".rds", sep = ""))
```

# 3. Overview of ISL1 and NKX2.5 Expression

```{r}
pdf(paste("../analyses", baseName, "_DimPlot_overview.pdf", sep = ""))
DimPlot(cp_cardiac_WT, reduction = "umap")
dev.off()

pdf(paste("../analyses", baseName, "_FeaturePlot_ISL1_NKX25.pdf", sep = ""))
FeaturePlot(cp_cardiac_WT,  features = "ISL1")
FeaturePlot(cp_cardiac_WT,  features = "NKX2-5")
dev.off()
```
